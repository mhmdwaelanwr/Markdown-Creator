...
export default function YouTubeHelperDialog({ visible, onClose, initialUrl = '', onSelect, isDark: isDarkProp }) {
  ...
  return (
    <AppDialog
      ...
      subtitle="Paste a YouTube URL to embed it."
      icon="youtube"
      maxWidth={640}
      scroll={false}
      footer={
    ...
    >
      <View>
        <Text style={[styles.label, { color: isDark ? Colors.textSecondaryDark : Colors.textSecondaryLight }]}>YouTube URL</Text>
        <TextInput
          style={inputChrome}
